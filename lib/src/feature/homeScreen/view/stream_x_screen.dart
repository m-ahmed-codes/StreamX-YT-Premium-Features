            ...
            sliver: SliverList(
              delegate: SliverChildListDelegate(
                [
                  ...
                  Obx(() => _buildVideoPreviewSection(primaryColor, cardBackgroundColor, textColor, secondaryTextColor)),
                ],
              ),
            ),
          ),
  ...
  Widget _buildUrlInputSection(Color primaryColor, Color secondaryTextColor, Color backgroundColor, bool isDarkMode) {
    ...
    return Column(
      ...
      children: [
        ...
        Obx(() => ElevatedButton(
          onPressed: homeScreenController.isLoading.value ? null : () => homeScreenController.loadVideo(),
              ...
              children: [
                AspectRatio(
                  ...
                  child: ClipRRect(
                    ...
                    child: homeScreenController.chewieController != null
                        ? Chewie(controller: homeScreenController.chewieController!)
                        : Container(
                            color: Colors.black,
                            child: Center(
                              child: Column(
              ...
              child: Row(
                children: [
                  Obx(() => ClipRRect(
                    ...
                    child: homeScreenController.thumbnailUrl.value.isNotEmpty
                        ? Image.network(
                  ...
                  Obx(() => IconButton(
                    icon: Icon(
                      homeScreenController.isPlaying.value ? Icons.pause : Icons.play_arrow,
                      size: 30,
                    ),
                    color: textColor,
